...
import static ua.javarush.TelegramBotUtils.addGlories;

public class MyFirstTelegramBot extends TelegramLongPollingBot {
    @Override
    public String getBotUsername() {
        // TODO: додай ім'я бота в лапки нижче
        return System.getenv(String.valueOf("USER_NAME"));
    }

    @Override
    public String getBotToken() {
        // TODO: додай токен бота в лапки нижче
//        return "6757551837:AAFFpLEokOiXPnK-2A-KeTxWMTYUVrcmSd4";
        return System.getenv(String.valueOf("TOKEN"));
    }
